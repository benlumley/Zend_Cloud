<?php
// Call Zend_Cloud_Storage_Adapter_AzureTest::main() if this source file is executed directly.
if (!defined("PHPUnit_MAIN_METHOD")) {
    // @TODO Switch to relative path when this is added to ZF
    require_once dirname(__FILE__) . '/../../../../TestHelper.php';
    define("PHPUnit_MAIN_METHOD", "Zend_Cloud_Storage_Adapter_WindowsAzureTest::main");
}
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Cloud_Storage_Adapter_WindowsAzureTest extends Zend_Cloud_StorageServiceTestCase
{
	/**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite("Zend_Cloud_Storage_Adapter_WindowsAzureTest");
