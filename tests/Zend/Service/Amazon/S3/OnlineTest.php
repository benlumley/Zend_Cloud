 ...
 * @version    $Id: OnlineTest.php 18950 2009-11-12 15:37:56Z alexander $
 */
...
class Zend_Service_Amazon_S3_OnlineTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->_amazon = new Zend_Service_Amazon_S3(constant('TESTS_ZEND_SERVICE_AMAZON_ONLINE_ACCESSKEY'),
...
/**
    ...
    public function testObjectEncoding()
    {
        ...
        $this->_amazon->putObject($this->_bucket."/Ñ?Ñ‚Ð¾ Ñ‚Ð¾Ð¶Ðµ Ñ‚ÐµÑ?Ñ‚!", "testdata123");
        $this->assertEquals("testdata123", $this->_amazon->getObject($this->_bucket."/Ñ?Ñ‚Ð¾ Ñ‚Ð¾Ð¶Ðµ Ñ‚ÐµÑ?Ñ‚!"));
    }
