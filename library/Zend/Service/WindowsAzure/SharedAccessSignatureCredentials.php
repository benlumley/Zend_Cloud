 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */ 
class Zend_Service_WindowsAzure_SharedAccessSignatureCredentials extends Zend_Service_WindowsAzure_Credentials
{
    /**
     * Permission set
     * 
	...
	/**
	 * Creates a new Zend_Service_WindowsAzure_SharedAccessSignatureCredentials instance
	 *
	 ...
	 */
	public function __construct($accountName = Zend_Service_WindowsAzure_Credentials::DEVSTORE_ACCOUNT, $accountKey = Zend_Service_WindowsAzure_Credentials::DEVSTORE_KEY, $usePathStyleUri = false, $permissionSet = array())
	{
	 ...
	 * Zend_Service_WindowsAzure_SharedAccessSignatureCredentials instance
	 * 
	 ...
	 */
    public function permissionMatchesRequest($permissionUrl = '', $requestUrl = '', $resourceType = Zend_Service_WindowsAzure_Storage::RESOURCE_UNKNOWN, $requiredPermission = Zend_Service_WindowsAzure_Credentials::PERMISSION_READ)
    {
        // Build requirements
