 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */ 
abstract class Zend_Service_WindowsAzure_Credentials
{
	/**
	...
	/**
	 * Creates a new Zend_Service_WindowsAzure_Credentials instance
	 *
	 * @param string $accountName Account name for Windows Azure
	 * @param string $accountKey Account key for Windows Azure
	 * @param boolean $usePathStyleUri Use path-style URI's
	 */
	public function __construct($accountName = Zend_Service_WindowsAzure_Credentials::DEVSTORE_ACCOUNT, $accountKey = Zend_Service_WindowsAzure_Credentials::DEVSTORE_KEY, $usePathStyleUri = false)
	{
	 ...
	 * @param string $value
	 */
	public function setAccountName($value = Zend_Service_WindowsAzure_Credentials::DEVSTORE_ACCOUNT)
	{
	 ...
	 * @param string $value
	 */
	public function setAccountkey($value = Zend_Service_WindowsAzure_Credentials::DEVSTORE_KEY)
	{
	 ...
	 */
	public abstract function signRequestHeaders($httpVerb = Zend_Service_WindowsAzure_Http_Transport::VERB_GET, $path = '/', $queryString = '', $headers = null, $forTableStorage = false, $resourceType = Zend_Service_WindowsAzure_Storage::RESOURCE_UNKNOWN, $requiredPermission = Zend_Service_WindowsAzure_Credentials::PERMISSION_READ);
